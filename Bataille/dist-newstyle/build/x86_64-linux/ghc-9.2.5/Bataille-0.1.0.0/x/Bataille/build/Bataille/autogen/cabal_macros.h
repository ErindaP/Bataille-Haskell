...
/* package Bataille-0.1.0.0 */
#ifndef VERSION_Bataille
#define VERSION_Bataille "0.1.0.0"
#endif /* VERSION_Bataille */
#ifndef MIN_VERSION_Bataille
#define MIN_VERSION_Bataille(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Bataille */
...
#define CURRENT_COMPONENT_ID "Bataille-0.1.0.0-inplace-Bataille"
