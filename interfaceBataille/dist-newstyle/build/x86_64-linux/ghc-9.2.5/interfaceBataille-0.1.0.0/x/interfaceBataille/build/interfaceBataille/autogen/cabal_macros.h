...
/* package interfaceBataille-0.1.0.0 */
#ifndef VERSION_interfaceBataille
#define VERSION_interfaceBataille "0.1.0.0"
#endif /* VERSION_interfaceBataille */
#ifndef MIN_VERSION_interfaceBataille
#define MIN_VERSION_interfaceBataille(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_interfaceBataille */
...
#define CURRENT_COMPONENT_ID "interfaceBataille-0.1.0.0-inplace-interfaceBataille"
